...
import com.clinicapp.databinding.FragmentGloSearchPatientsBinding;
...
public class GloSearchPatientsFragment extends BaseFragment {
    private SearchPatientViewModel viewModel;
    private MainViewModel mainViewModel;
    private FragmentGloSearchPatientsBinding views;


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        views = FragmentGloSearchPatientsBinding.inflate(getLayoutInflater(), container, false);
    ...
    private void handleSearchResults(List<Patient> patients) {
        if (patients.size() > 0) {
            ...
            GloSearchResultsContainerFragment returnToGloHomeFragment = new GloSearchResultsContainerFragment();
