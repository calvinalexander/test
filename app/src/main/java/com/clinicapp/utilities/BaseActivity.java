...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public void onClickGloSetSelected(View v){
        CheckBox checkBox;
        switch(v.getId()){
            case R.id.right_face_container: checkBox=v.findViewById(R.id.right_side);
                checkBox.setChecked(!checkBox.isChecked());
                break;
            case R.id.front_face_container: checkBox=v.findViewById(R.id.front_side);
                checkBox.setChecked(!checkBox.isChecked());
                break;
            case R.id.left_face_container: checkBox=v.findViewById(R.id.left_side);
                checkBox.setChecked(!checkBox.isChecked());
                break;
